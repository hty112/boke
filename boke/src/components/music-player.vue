  ...
  <div class="music-box">
    ...
    <div class="music-list-all">
      ...
      <div class="music-list-box">
        <ul class="music-list">
          <li @click="active(index)" :class="[{active:index == ins},{noactive:index != ins}]" v-for="(item,index) in song" :key="index">{{item}}</li>
        </ul>
      </div>
    </div>
  </div>
...
export default {
  ...
  data(){
    return{
      ...
      music_path:require('../assets/song/su.mp3'),
      isPlay:false,
      song:['溯','枫','晴天','衝撃'],
      ins:0,
      current:0,
  ...
  methods:{
    active(index){
      ...
      switch (index){
        case 0:
          this.music_path=require('../assets/song/su.mp3')
        break;
        case 1:
          this.music_path=require('../assets/song/feng.mp3')
          break;
        case 2:
          this.music_path=require('../assets/song/qingtian.mp3')
          break;
        case 3:
          this.music_path=require('../assets/song/chongji.mp3')
          break;
        default: break;
      }
      this.isPlay = true
